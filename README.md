...
A criação faz parte do projeto integrador do curso de Ciência da Computação, voltado ao desenvolvimento de um site institucional para uma escola.

A proposta do projeto é desenvolver uma aplicação web simples, moderna e acessível, que funcione como uma vitrine digital da escola. O site permitirá a divulgação de informações institucionais, apresentação da escola e disponibilização de canais de contato.
...
- ⚛️ **React / Next.js**  
  ...
  O Next.js também contribui para otimização de SEO e renderização eficiente.
